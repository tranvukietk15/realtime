...
public class ProjectsController : BaseApiController
{
  ...
  public async Task<IActionResult> Put(int projectId, [FromBody] CreateProjectDTO request)
  {
    var existProject = await _repository.GetByIdAsync(projectId);
    if (existProject == null) return NotFound("No such project");
    existProject.UpdateName(request.Name);
